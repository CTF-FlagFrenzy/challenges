    ...
    try:
        ...
        for layer in range(1, max_layers + 1):
            ...
            if layer % batch_size == 0:
                ...
                logger.info(f"Performance: {layers_per_second:.1f} layers/sec | " +
        ...
        logger.info(f"Total creation time: {total_time:.2f} seconds ({total_time/60:.2f} minutes)")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Erstellt eine rekursiv verschachtelte ZIP-Datei')
    parser.add_argument('--status-file', type=str, help='Pfad zur Statusdatei', default=None)
